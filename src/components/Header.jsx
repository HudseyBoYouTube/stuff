...
export function Header({ 
  ...
  return (
    <header className={`border-b ${isLightMode ? 'bg-[#09090b]/95 border-black/5 text-black' : 'bg-[#09090b]/95 border-white/5 text-white'} h-16 flex items-center px-4 backdrop-blur-md sticky top-0 z-50 transition-colors`}>
