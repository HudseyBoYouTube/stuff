          ...
          >
            ...
            >
              ...
              <select 
                ...
                className="w-full bg-black text-zinc-100 border border-white/10 rounded-xl p-3 text-sm focus:outline-none focus:border-[#10A5F5] appearance-none"
              >
                <option value="none" className="bg-black text-white">None (Default)</option>
                <option value="schoology" className="bg-black text-white">Schoology</option>
                <option value="google" className="bg-black text-white">Google Drive</option>
                <option value="canvas" className="bg-black text-white">Canvas</option>
              </select>
            </motion.div>
          </motion.div>
        )}
